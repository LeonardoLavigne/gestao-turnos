...
from app.infrastructure.telegram.handlers.commands import (
    start_command,
    ajuda_command,
    assinar_command,
    perfil_command,
)
from app.infrastructure.telegram.handlers.onboarding import (
    AGUARDANDO_NOME,
    AGUARDANDO_NUMERO,
    iniciar_onboarding,
    receber_nome,
...
from app.infrastructure.telegram.handlers.turnos import (
    registrar_turno_msg,
    remover_command,
)
from app.infrastructure.telegram.handlers.relatorios import (
    relatorio_semana_command,
    relatorio_mes_command,
)
from app.infrastructure.telegram.handlers.menu import (
    menu_command,
    button_handler,
)
